...
To compile from source you will need Go 1.17 or newer:

    $ git clone https://github.com/bhojpur/configure.git
    $ cd pkg/toml/internal/toml
    $ go build ./cmd/toml-test

This will build a `./toml-test` binary.

[r]: https://github.com/bhojpur/configure/releases
...
For example, to run the tests against the Go TOML library:
    ...
    # Install our Parser
    $ go install github.com/bhojpur/configure/pkg/toml/cmd/toml-test-decoder@master
    $ go install github.com/bhojpur/configure/pkg/toml/cmd/toml-test-encoder@master
...
best-day-ever = 2018-03-26T17:45:00Z
...
{
  "best-day-ever": {"type": "datetime", "value": "2018-03-26T17:45:00Z"},
  "numtheory": {
...
An example implementation can be found in the github.com/bhojpur/configure/pkg/toml:

- [Add tags](https://github.com/bhojpur/configure/blob/master/pkg/toml/internal/tag/add.go)
- [Remove tags](https://github.com/bhojpur/configure/blob/master/toml/internal/tag/rm.go)
...
- When testing encoders, the TOML decoder at
  [bhojpur/configyre/pkg/toml](https://github.com/bhojpur/configure/pkg/toml) is assumed to be 
...
Our decision to use JSON was not a careful one. It was based on expediency. The
